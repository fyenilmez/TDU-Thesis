...
model = tf.keras.applications.ResNet152V2(include_top=False, input_shape=(224, 224, 3), pooling='avg', weights = 'imagenet')
...
model.load_weights('ResNet152_imagenet_weights_w_Dense_improvement-22-0.71.hdf5')
