...
model = tf.keras.applications.VGG19(include_top=False, input_shape=(224, 224, 3), pooling='avg', weights = 'imagenet')
...
model.load_weights('VGG19_imagenet_weights_w_Dense_improvement-32-0.71.hdf5')
