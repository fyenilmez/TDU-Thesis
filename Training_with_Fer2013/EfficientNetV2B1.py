...
model = tf.keras.applications.EfficientNetV2B1(include_top=False, input_shape=(224, 224, 3), pooling='avg', weights = 'imagenet')
...
model.load_weights('EfficientNetV2B1_weights_improvement-33-0.70.hdf5')
