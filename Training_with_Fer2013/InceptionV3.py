...
model = tf.keras.applications.InceptionV3(include_top=False, input_shape=(224, 224, 3), pooling='avg', weights = 'imagenet')
...
model.load_weights('Inception_weights_improvement-33-0.71.hdf5')
