...
base_model = tf.keras.applications.EfficientNetV2B1(weights='imagenet', include_top=False, pooling='avg',input_shape=input_shape)
...
filepath="Faces_MobileNetV2_weights_improvement-{epoch:02d}-{val_accuracy:.2f}.hdf5"
