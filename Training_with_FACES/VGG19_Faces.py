...
base_model = tf.keras.applications.VGG19(weights='imagenet', include_top=False, pooling='avg',input_shape=input_shape)
...
filepath="Faces_VGG19_weights_improvement-{epoch:02d}-{val_accuracy:.2f}.hdf5"
...
model.load_weights('Faces_VGG19_weights_improvement-27-0.95.hdf5') 
