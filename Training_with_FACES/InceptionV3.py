...
base_model = tf.keras.applications.InceptionV3(weights='imagenet', include_top=False, pooling='avg',input_shape=input_shape)
...
filepath="Faces_InceptionV3_weights_improvement-{epoch:02d}-{val_accuracy:.2f}.hdf5"
...
model.load_weights('Faces_InceptionV3_weights.hdf5') 
